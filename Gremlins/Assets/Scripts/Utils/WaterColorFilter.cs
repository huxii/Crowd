...
namespace WaterColorFilterSystem {
	...
	public class WaterColorFilter : MonoBehaviour {
        ...
        public const string PROP_WOBB_TEX_EDGE = "_WobbTex0";
        public const string PROP_WOBB_TEX_EDGE_SCALE = "_WobbScale0";
        public const string PROP_WOBB_EDGE_POWER = "_WobbPower0";
        ...
        public const string PROP_CLEAN_TEX = "_CleanMainTex";
        ...
        public Texture wobbEdgeTex;
        public float wobbEdgeScale = 1f;
        public float wobbEdgePower = 0.01f;
		...
		void OnRenderImage(RenderTexture src, RenderTexture dst) {
            ...
            _filterMat.SetTexture(PROP_WOBB_TEX_EDGE, wobbEdgeTex);
            _filterMat.SetFloat(PROP_WOBB_TEX_EDGE_SCALE, wobbEdgeScale);
            _filterMat.SetFloat(PROP_WOBB_EDGE_POWER, wobbEdgePower);
            _filterMat.SetTexture(PROP_CLEAN_TEX, src);
